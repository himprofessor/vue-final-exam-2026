...
export const useTaskStore = defineStore('tasks', () => {
  ...
  async function createTask(payload: TaskPayload) {
    ...
    try{
      ...
      error.value=err.response?.data?.message ||'Fail to create task'
      return false
    } finally {
      loading.value=false
    }
  ...
  // -----------------------------------------------------------------------
  async function updateTask(id: number, payload: TaskPayload) {    // TODO: replace this with a real implementation
    loading.value=true
    error.value=null
    try{
      ...
      error.value=err.response?.data?.message ||'Fail to update task'
      return false
    } finally {
      loading.value=false
    }
  ...
  async function deleteTask(id: number) {
    ...
    try{
      ...
      error.value=err.response?.data?.message ||'Fail to delete task'
      return false
    } finally {
      loading.value=false
    }
