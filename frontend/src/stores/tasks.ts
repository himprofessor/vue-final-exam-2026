// =====================================================================
// Tasks store
//THIS IS YOUR MAIN EXAM TASK. // // The `categories` store (stores/categories.ts) is a complete working // 
// example. This file follows the exact same pattern, but several // actions are left as TODOs for you to finish. 
...
//Todo: replace this with a real implementation
  ...
  // Provided for you: a small "quick toggle" action
  ...
  function setFilters(newFilters: Partial<TaskFilters>) {
    filters.value = {
      ...filters.value,
      ...newFilters,
      page: 1 // Reset back to page 1 on filter changes
    }
    fetchTasks()
  }
